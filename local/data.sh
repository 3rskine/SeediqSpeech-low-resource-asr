...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    ...
    echo "Skipping combine" # --extra_files utt2num_frames data/${train_set} data/train_clean_100 data/train_clean_360 data/train_other_500
    echo "Skipping combine" # --extra_files utt2num_frames data/${train_dev} data/dev_clean data/dev_other
fi
